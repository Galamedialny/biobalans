...
export default function Home() {
  return <main>
    ...
    <footer><div className="footer-brand"><Image src="/images/biobalans-logo.webp" alt="" width={48} height={48}/><b>BIO BALANS</b></div><p>Prevádzkovateľ: optiMM s. r. o. · IČO: 47432489 · DIČ: 2023891177</p><p>© {new Date().getFullYear()} BioBalans</p></footer>
  </main>;
}
