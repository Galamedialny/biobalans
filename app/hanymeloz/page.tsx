...
const gallery = [["/images/hanka-cita.webp","Knihy miluje a v nemocnici je dosť času na čítanie."],["/images/hanka-stolickovy-vytah.webp","Hanka a jej pomocník – stoličkový výťah."],["/images/hanka-peptidove-preparaty.webp","Aj vďaka vašej podpore môžeme využívať špeciálne peptidové preparáty."],["/images/hanka-tvori.webp","Aj v nemocnici rada tvorí."],["/images/hanka-bratislava.webp","Potulky po Bratislave po návšteve Národného ústavu detských chorôb."],["/images/hanka-zvieratka.webp","Miluje zvieratká."],["/images/hanka-schodochod.webp","Podpora na schodolez v hodnote 1 500 €."],["/images/hanka-respect.webp","Príspevok 800 € od Nadácie Respect."]];
...
export default function HanyMelPage(){return <main className="hany-page"><script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify(structuredData)}}/>
  ...
  <section id="podpora" className="support-section"><div><p className="eyebrow light">Podporte Hanku</p><h2>Každý príspevok pomáha meniť každodennosť.</h2><p>Vaša pomoc podporí liečbu, rehabilitácie, špeciálne pomôcky a úpravy, ktoré Hanke umožnia byť samostatnejšou.</p></div><div className="bank-card"><div className="bank-details"><small>Účet občianskeho združenia</small><b>SK42 7500 0000 0040 3516 5049</b><span>HanyMel OZ · IČO: 55971334</span><a href="mailto:hanymel@biobalans.sk">hanymel@biobalans.sk</a></div><div className="bank-qr"><Image src="/images/hanymel-qr-platba.png" alt="QR kód na priamu platbu pre HanyMel OZ" width={512} height={600}/><small>Naskenujte QR kód v mobilnej bankovej aplikácii</small></div></div></section>
